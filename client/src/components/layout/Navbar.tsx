          ...
          <div className="flex items-center gap-2">
            <Link href={isDealer ? "/workspace" : "/login"}>
              <Button 
                variant="ghost" 
                size="sm" 
                className="text-muted-foreground hover:text-emerald-600 gap-1.5 h-9 rounded-lg px-2 sm:px-3"
              >
                <Store className="h-4 w-4" />
                <span className="text-xs font-medium hidden sm:inline">Dealer</span>
              </Button>
            </Link>
            ...
            <Link href={isAdmin ? "/admin/dashboard" : "/admin/login"}>
              <Button 
                variant="ghost" 
                size="sm" 
                className="text-muted-foreground hover:text-blue-600 gap-1.5 h-9 rounded-lg px-2 sm:px-3"
              >
