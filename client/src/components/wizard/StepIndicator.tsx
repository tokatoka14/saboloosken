...
export function StepIndicator({ currentStep }: StepIndicatorProps) {
  const steps = [
    ...
    { num: 2, title: "შემოწმება" },
    { num: 3, title: "პროფილი" },
    { num: 4, title: "პროდუქტი" },
    { num: 5, title: "დასრულება" },
  ];
        ...
        {steps.map((step) => {
          ...
          return (
            <div key={step.num} className="relative z-10 flex flex-col items-center gap-3">
              ...
              <span 
                className={cn(
                  "text-xs font-semibold absolute -bottom-6 w-20 text-center transition-colors duration-300 hidden sm:block",
