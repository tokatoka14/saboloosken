...
export const submissionSchema = z.object({
  documentType: z.enum(["id_card", "passport"]).default("id_card"),
  idFront: z.string().optional(), // base64
  idBack: z.string().optional(), // base64
  passportPhoto: z.string().optional(), // base64
  firstName: z.string(),
  lastName: z.string(),
  idNumber: z.string(),
  ...
  addressVillage: z.string().min(1, "მონტაჟის მისამართი აუცილებელია"),
  ...
  pensionerVerified: z.boolean().optional(),
  ...
  ovenCode: z.string().optional(), // Used in wizard
